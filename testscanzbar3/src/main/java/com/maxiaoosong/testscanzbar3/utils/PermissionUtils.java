package com.maxiaoosong.testscanzbar3.utils;
...
import com.maxiaoosong.testscanzbar3.R;
...
public class PermissionUtils {
    ...
    public static final int CODE_READ_CALENDAR = 2;
    ...
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "应该打开这个权限",
    ...
    private static void shouldShowRationale(final Activity activity, final int requestCode, final String requestPermission) {
        ...
        showMessageOKCancel(activity, "通知： " + permissionsHint[requestCode], new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
